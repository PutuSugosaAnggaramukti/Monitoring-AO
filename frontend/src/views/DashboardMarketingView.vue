  ...
  <v-container fluid class="pa-6">
    ...
    <v-row class="mb-2">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-5 rounded-xl elevation-2 stat-card" border>
          <div class="d-flex justify-space-between align-start">
            <div>
              <div class="text-overline text-grey-darken-1">Total Prospek</div>
              <div class="text-h4 font-weight-black text-primary mt-1">128</div>
            </div>
            <v-avatar color="blue-lighten-5" size="48">
              <v-icon color="primary">mdi-account-search</v-icon>
            </v-avatar>
          </div>
          <div class="text-caption text-grey mt-4">+12 prospek baru hari ini</div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-5 rounded-xl elevation-2 stat-card" border>
          <div class="d-flex justify-space-between align-start">
            <div>
              <div class="text-overline text-grey-darken-1">Nasabah Baru</div>
              <div class="text-h4 font-weight-black text-success mt-1">24</div>
            </div>
            <v-avatar color="green-lighten-5" size="48">
              <v-icon color="success">mdi-account-plus</v-icon>
            </v-avatar>
          </div>
          <div class="text-caption text-grey mt-4">Closing bulan ini</div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-5 rounded-xl elevation-2 stat-card" border>
          <div class="d-flex justify-space-between align-start">
            <div>
              <div class="text-overline text-grey-darken-1">Pending Survey</div>
              <div class="text-h4 font-weight-black text-warning mt-1">18</div>
            </div>
            <v-avatar color="orange-lighten-5" size="48">
              <v-icon color="warning">mdi-timer-sand</v-icon>
            </v-avatar>
          </div>
          <div class="text-caption text-grey mt-4">Menunggu tindak lanjut</div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-5 rounded-xl elevation-2 stat-card" border>
          <div class="d-flex justify-space-between align-start">
            <div>
              <div class="text-overline text-grey-darken-1">Target Bulanan</div>
              <div class="text-h4 font-weight-black text-info mt-1">72%</div>
            </div>
            <v-avatar color="light-blue-lighten-5" size="48">
              <v-icon color="info">mdi-target</v-icon>
            </v-avatar>
          </div>
          <v-progress-linear model-value="72" color="info" height="7" rounded class="mt-4" />
        </v-card>
      </v-col>
        ...
        <v-col cols="12" lg="7">
          <v-card class="rounded-xl elevation-2 pa-5 fill-height">
            <div class="d-flex align-center mb-4">
              ...
              <div class="text-h6 font-weight-bold">Aktivitas Terbaru AO</div>
            </div>

            <v-timeline density="compact" align="start">
              <v-timeline-item dot-color="success" size="small">
                <div class="font-weight-medium">AO Rina berhasil closing nasabah baru</div>
                <div class="text-caption text-grey">Kredit UMKM Rp 150.000.000 - 5 menit lalu</div>
              </v-timeline-item>

              <v-timeline-item dot-color="primary" size="small">
                <div class="font-weight-medium">AO Budi menambahkan prospek baru</div>
                <div class="text-caption text-grey">Calon nasabah wilayah Bantul - 12 menit lalu</div>
              </v-timeline-item>

              <v-timeline-item dot-color="warning" size="small">
                <div class="font-weight-medium">Survey lapangan dijadwalkan ulang</div>
                <div class="text-caption text-grey">Nasabah belum berada di lokasi - 30 menit lalu</div>
              </v-timeline-item>

              <v-timeline-item dot-color="info" size="small">
                <div class="font-weight-medium">Pengajuan kredit disetujui</div>
                <div class="text-caption text-grey">Oleh Supervisor Marketing - 1 jam lalu</div>
              </v-timeline-item>

              <v-timeline-item dot-color="error" size="small">
                <div class="font-weight-medium">Follow up belum dilakukan</div>
                <div class="text-caption text-grey">3 prospek belum dihubungi - 2 jam lalu</div>
              </v-timeline-item>
            </v-timeline>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" lg="5">
          ...
          <v-card class="rounded-xl elevation-2 pa-5">
            ...
            <v-alert type="warning" variant="tonal" density="compact" class="mb-3">
              3 survey jatuh tempo hari ini
            </v-alert>
            <v-alert type="info" variant="tonal" density="compact" class="mb-3">
              5 prospek perlu follow up
            </v-alert>
            <v-alert type="success" variant="tonal" density="compact">
              Target mingguan hampir tercapai
            </v-alert>
          </v-card>
            ...
            <v-table>
              ...
              <tbody>
                <tr v-for="ao in aoPerformance" :key="ao.name">
                  ...
                  <td>{{ ao.closing }}</td>
                  <td>
                    <v-chip :color="ao.statusColor" size="small" variant="flat">
                      {{ ao.status }}
                    </v-chip>
                  </td>
                </tr>
        ...
        <v-col cols="12">
          <v-card class="rounded-xl elevation-2 pa-5">
            <div class="d-flex align-center mb-4">
              ...
              <div class="text-h6 font-weight-bold">Reminder Hari Ini</div>
            </div>
            <v-alert type="warning" variant="tonal" density="compact" class="mb-3">
              3 survey jatuh tempo hari ini
            </v-alert>
